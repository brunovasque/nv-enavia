...
describe("PR4 — fetchContractSurface API", () => {
  it("returns ACTIVE_ALLOW data by default", async () => {
  ...
  it("returns NO_CONTRACT when requested", async () => {
  ...
  it("returns BLOCK state correctly", async () => {
    const { fetchContractSurface, CONTRACT_SURFACE_STATUS } = await import("../api/endpoints/contract.js");
  ...
  it("returns WARN state correctly", async () => {
    const { fetchContractSurface, CONTRACT_SURFACE_STATUS } = await import("../api/endpoints/contract.js");
...
// ── 6. Integration — export from api/index.js ──────────────────────────────
