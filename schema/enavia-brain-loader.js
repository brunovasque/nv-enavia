...
const BRAIN_SNAPSHOT_BLOCKS = [
...

  {
    ...
    body: [
      ...
      "Frente 2 (anti-bot PR32–PR38) concluída: chat não responde mais como bot.",
      "Frente 3 (Obsidian Brain): brain documental existe; PR43 implementa o primeiro Brain Loader read-only.",
      "O que existe em runtime: chat funcional, sanitizers preservando prosa útil, isOperationalMessage refinado, bloco operacional pesado só com is_operational_context=true.",
      "O que existe documentalmente (NÃO runtime): Obsidian Brain, self-model, MODE_POLICY, skills, system/route/worker registries.",
      ...
      "  • Endpoint `/skills/run`, escrita de memória automatizada, update supervisionado, Self-Audit.",
    ].join("\n"),
  },
